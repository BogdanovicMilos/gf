...
function initJS() {
  ...
  $('#trigger').length && myScrollMagic(jQuery)
  servicesSwiper(jQuery);
  serviceClientsSwiper(jQuery);
  serviceProcessSwiper(jQuery);
  $('#trigger-service').length && myScrollMagicService(jQuery)
...
function introHexagon($) {
  ...
  setInterval(function() {
    let nth = Math.floor(Math.random() * max),
      left = $('.intro__hexagon-bg path:nth-child(' + nth + ')').offset().left,
      top = $('.intro__hexagon-bg path:nth-child(' + nth + ')').offset().top;
...
function myScrollMagic($) {
  ...
  var controller = new ScrollMagic.Controller(),
    vh = $(window).innerHeight(), ww = $(window).innerWidth(),
    isInner = false;
  // build scene
  var scene = new ScrollMagic.Scene({ triggerElement: "#trigger", duration: $('#trigger').height() })
    ...
    .on("start", function(event) {
      ...
      setTimeout(function() {
        if (isInner && ww>=1024) {
          $('.home_about__itm').removeClass('active');
          $('.home_about__itm').first().addClass('active');
          $('html, body').animate({
    ...
    .on("end", function(event) {
      setTimeout(function() {
        if (isInner && ww>=1024) {
          $('.home_about__itm').removeClass('active');
          $('.home_about__itm').last().addClass('active');
          $('html, body').animate({
            scrollTop: $('#trigger').offset().top + $('#trigger').height() - vh
          }, 500);
        }
      }, 100)
    })
  ...
  var scene1 = new ScrollMagic.Scene({ triggerElement: "#home_about__itm-1", duration: $('#home_about__itm-1').height() })
    .addTo(controller)
    .on("start", function(event) {
  ...
  var scene2 = new ScrollMagic.Scene({ triggerElement: "#home_about__itm-2", duration: $('#home_about__itm-2').height() })
    .addTo(controller)
    .on("start", function(event) {
      if (event.scrollDirection == 'FORWARD') {
        slide = 2;
  ...
  var scene3 = new ScrollMagic.Scene({ triggerElement: "#home_about__itm-3", duration: $('#home_about__itm-3').height() })
    .addTo(controller)
    .on("start", function(event) {
      if (event.scrollDirection == 'FORWARD') {
        slide = 3;
      ...
      if (delta > 0) {
        if (slide == 3) {
          $('html, body').stop().animate({
            scrollTop: $('#trigger').offset().top + $('#trigger').height()
          }, 500);
        } else {
          $('html, body').stop().animate({
            scrollTop: $('#home_about__itm-' + (slide + 1)).offset().top
          }, 500);
        }
      } else {
        if (slide == 1) {
          $('html, body').stop().animate({
            scrollTop: $('#trigger').offset().top - vh
          }, 500);
        } else {
          $('html, body').stop().animate({
            scrollTop: $('#home_about__itm-' + (slide - 1)).offset().top
...
function myScrollMagicService($) {
  // init controller
  var controller = new ScrollMagic.Controller(),
    vh = $(window).innerHeight(), ww = $(window).innerWidth(),
    isInner = false;
  // build scene
  var scene = new ScrollMagic.Scene({ triggerElement: "#trigger-service", duration: $('#trigger-service').height() })
    .addTo(controller)
    .on("start", function(event) {
      setTimeout(function() {
        if (isInner && ww>=1024) {
          ...
          // $('.home_about__itm').first().addClass('active');
          $('html, body').animate({
            scrollTop: $('#trigger-service').offset().top
          }, 500);
        }
      }, 100)
    })
    .on("end", function(event) {
      setTimeout(function() {
        if (isInner && ww>=1024) {
          ...
          // $('.home_about__itm').last().addClass('active');
          $('html, body').animate({
            scrollTop: $('#trigger-service').offset().top + $('#trigger-service').height() - vh
          }, 500);
        }
      }, 100)
    })
  ...
  var scene1 = new ScrollMagic.Scene({ triggerElement: "#trigger-service-section-1", duration: $('#trigger-service-section-1').height() })
    .addTo(controller)
    .on("start", function(event) {
      if (event.scrollDirection == 'FORWARD') {
        slideService = 1;
  ...
  var scene2 = new ScrollMagic.Scene({ triggerElement: "#trigger-service-section-2", duration: $('#trigger-service-section-2').height() })
    .addTo(controller)
    .on("start", function(event) {
      if (event.scrollDirection == 'FORWARD') {
        slideService = 2;
